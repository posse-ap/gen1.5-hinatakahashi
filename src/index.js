'use strict';
//学習時間棒グラフ
var context = document.getElementById("studytime_bargraph").getContext("2d");
var data_information = new Chart(context, {
  type: 'bar',                           //◆棒グラフ
  // lineWidth: 100,
  data: {                                //◆データ
...
//↓円グラフ１
var language_data = document.getElementById("piechart1");
var piechart1 = new Chart(language_data, {
  type: 'doughnut',
  data: {
    labels: { //データ項目のラベル
      display: false
...
//↓円グラフ２
var content_data = document.getElementById("piechart2");
var piechart2 = new Chart(content_data, {
  type: 'doughnut',
  data: {
    labels: { //データ項目のラベル 
      display: false

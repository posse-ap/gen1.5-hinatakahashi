                        ...
                        <div class="language-card-container">
                            ...
                            <div class="language-tag">
                                @foreach ($languages as $language)
                                    <p>
                                        <span class="circle"
                                            style="background-color: {{ $language->color_code }}"></span>
                        ...
                        <div class="contents-card-container">
                            ...
                            <p class="contents-tag">
                                @foreach ($contents as $content)
                                    <p>
                                        <span class="circle"
                                            style="background-color: {{ $content->color_code }}"></span>
                        ...
                        <div class="form-group d-lg-flex justify-content-between">
                            <div class="modal-left-parts">
                                <div class="modal-date-part">
                                    ...
                                    <input type="text" id="studyDate" data-toggle="modal"
                                        data-target="#modalCalendar" name="date" readonly>
                                </div>
                                <div class="modal-contents-pc-part d-none d-lg-block pt-3">
                                    ...
                                    @foreach ($contents as $content)
                                        <input id={{ $content->id }} type="checkbox" value={{ $content->id }}
                                            name="contents[]">
                                ...
                                <div class="modal-contents-sp-part d-block d-lg-none pt-3">
                                    ...
                                    @foreach ($languages as $language)
                                        <input id={{ $language->id }} type="checkbox" value={{ $language->id }}
                                            name="languages[]">
                            ...
                            <div class="modal-right-parts pt-3 pt-lg-0">
                                ...
                                <div class="modal-twitter-auto-part pt-1">
                                    <input id="twitter" type="checkbox" checked name="twitter"><label
                                        for="twitter">Twitterに自動投稿する</label>
                                </div>
                            </div>
                        </div>
                        <button type="button" class="post-btn d-block mx-auto mt-3 mb-4"
                            id="button1">記録・投稿</button>
                    </form>
                </div>
            </div>
        </div>
